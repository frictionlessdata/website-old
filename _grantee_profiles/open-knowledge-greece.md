...
authors: Open Knowledge Greece
image: open-knowledge-greece-logo.png
short_description: "Open Knowledge Greece are a Tool Fund grantee, extending implementation of Frictionless Data tools and libraries in R"
---
...
We were very excited when we read about [Frictionless Data](http://frictionlessdata.io/) on the [Open Knowledge International blog](https://blog.okfn.org) and have been following the progress of the project carefully. When we saw the Frictionless Data Tool Fund had been [announced](https://blog.okfn.org/2017/03/01/announcing-the-frictionless-data-tool-fund/), we were certain that we wanted to be part of this project and build tools that can help in removing the friction in working with data.
...
Interested in learning more about OK Greece? See their [Facebook](https://www.facebook.com/okfngreece/) page, read their [blog](http://okfn.gr/blog-magazine/) and watch their videos on [Youtube](https://www.youtube.com/channel/UCWk9gT45Pdgg2wUJg_bRxXg/).

...
context: " The Workforce Data Initiative uses Frictionless Data tools and specs to support collection and distribution of workforce data and statistics in the US. "
---
...
We use the frictionless data table schema spec to define the required columns and data value constraints.  This is decoupled from the code, allowing each state to precisely define their requirements and easily create custom instances of the site.  We expose this flexibility through a [Heroku build script](https://id.heroku.com/login).
